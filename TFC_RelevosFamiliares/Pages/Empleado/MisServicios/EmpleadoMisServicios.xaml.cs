...
public partial class EmpleadoMisServicios : ContentPage
{
    private readonly ApiService _api;
    private readonly TokenService _tokenService;

    public EmpleadoMisServicios()
    {
        InitializeComponent();
    ...
    protected override async void OnAppearing()
    {
        ...
        // ⚠️ No hay endpoint real → usamos lista vacía o mock
    ...
    private async void OnCancelarClicked(object sender, EventArgs e)
    {
        if (sender is Button btn && btn.BindingContext is not null)
        {
            ...
            await Shell.Current.GoToAsync($"///empleadoconfirmarcancelacion?id={id}");
        }
    }
}
